...
////////////////////////////////////////////////////////////////////////////////////////////
void N5110_write_y_byte(uint8_t x,uint8_t y,uint8_t data[8],uint8_t color){
...
void N5110_show_pic (uint8_t *pic,uint8_t xpos ,uint8_t ypos,uint8_t color){
  ...
  if( (pic_x+xpos)>84) return 0;
  if( (pic_y+ypos)>48) return 0;
 ...
 for(y=ypos;y<pic_y+ypos;y=y+8){
   ...
   for(x=xpos;x<pic_x+xpos;x++){
         ...
         repeat++;
           ...
           N5110_write_y_byte(x,y,data,color);
    }
